...
export default function Certifications() { return <RepeatableStep section="certifications" step={7} validate={validateCertifications} card={CertificationCard} label="Certification" /> }
