...
export default function WorkExperience() { return <RepeatableStep section="workExperience" step={4} validate={validateWorkExperience} card={WorkExperienceCard} label="Experience" /> }
