...
export default function Education() { return <RepeatableStep section="education" step={4} validate={validateEducation} card={EducationCard} label="Education" mandatory /> }
